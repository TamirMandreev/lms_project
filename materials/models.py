...
class Course(models.Model):
    ...
    owner = models.ForeignKey('users.User', on_delete=SET_NULL, null=True, blank=True, verbose_name='Владелец', help_text='Укажите владельца курса')
...
class Lesson(models.Model):
    ...
    owner = models.ForeignKey('users.User', on_delete=SET_NULL, null=True, blank=True, verbose_name='Владелец',
